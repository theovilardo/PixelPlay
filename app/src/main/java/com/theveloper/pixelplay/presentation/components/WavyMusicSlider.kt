...
//                        }
//
//                        // Asegurar que la onda termine en la posición correcta del thumb
//                        if (progressEnd > trackStart) {
//                            val finalWavePhase = waveFrequency * progressEnd + phaseShift
//                            val finalWaveY = centerY + waveAmplitudePx * sin(finalWavePhase)
//
//                            // Asegurar que la última posición esté en la onda
//                            lineTo(progressEnd, finalWaveY)
//                        }
//                    }
//
//                    // Dibujar la onda
...
//
//            // Dibujar thumb
//            val thumbRadius = if (isInteracting) thumbRadiusPx * 1.2f else thumbRadiusPx
//            drawCircle(
//                color = thumbColor,
//                radius = thumbRadius,
//                center = Offset(trackStart + trackWidth * normalizedValue, centerY)
//            )
//        }
//    }
//}